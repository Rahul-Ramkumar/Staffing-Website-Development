<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tips.aspx.cs" Inherits="WebApplication1.WebForm4" %>
...
<body style ="background-color:floralwhite;">
    <div class="container-fluid" style="margin-top: -20px; margin-left: -5px; margin-right: -5px;">
    <form id="form1" runat="server">
        <div>
            <img src="Tips.jpg" width=100% height=500px/>
        </div>
        <br />
        <div style="font-family:Calibri;">
        <div style="font-size:30px;">
            <b>Top Ten Questions to Ask a Staffing Agency</b>
        </div>
        If you've been thinking about temporary or contract work, you're not alone.
        According to the American Staffing Association, every day, 2.9 million people are on assignment with staffing companies.
        Whether you want a temporary job or a full-time position, working for a staffing agency is a great career move. 
        <br /><br />
        <div style="font-size:30px">Working with a Staffing Agency</div>
        <p> <span style="font-family: Calibri; font-size: large">To explore whether working with a staffing agency is the right choice for you, here are 10 questions to help you choose a prospective staffing agency: 
        <br /><br />

        <b>01. Does the staffing agency specialize in my field?</b>
        <br />
        Office managers, receptionists and other administrative skills should seek a staffing agency that focuses on those skills. 
        <br /><br />
        <b>02. Does the recruiter have industry-specific experience?</b>
        <br />
        ...
        <br /><br />
        <b>03. What's the recruiter's typical process for placing candidates?</b>
        <br />
        ...
        <br /><br />
        <b>04. How long has the staffing agency been in business?</b>
        <br />
        ...
        <br /><br />
        <b>05. How are you treated during the initial contact?</b>
        <br />
        ...
        <br /><br />
        <b>06. Does the staffing agency fully understand your needs?</b>
        <br />
        ...
        <br /><br />
        <b>07. How many openings does the staffing agency currently have for the position you seek?</b>
        <br />
        Will you have choices? Does the staffing agency have ten jobs that match your skills, or just one? 
        <br /><br />
        <b>08. Does the staffing agency have jobs where you want to be?</b>
        <br />
        ...
        <br /><br />
        <b>09. How well run is the organization?</b>
        <br />
        ...
        <br /><br />
        <b>10. What are your responsibilities for a potential position?</b>
        <br />
